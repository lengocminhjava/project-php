...
<html>
    <head>
        ...
        <base href="http://localhost/admin.php/projectmvc.vn/?mod=post&controllers=index&action=add"/>
        <script src="public/Ckeditor/ckeditor/ckeditor.js" type="text/javascript"></script>
    </head>
    <body>
        <style>
            #content{
