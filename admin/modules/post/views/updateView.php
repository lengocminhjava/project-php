                        ...
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="<?php echo $info_post['title'] ?>" name="name_title" id="name_title">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="post_content" class="form-control ckeditor" value="<?php echo $info_post['content'] ?>" id="content" cols="30" rows="5"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        <img class="form-input" src="<?php echo $info_post['thumbnail']; ?>" width="220" height="320" alt="">
                                    </p>
                                ...
                                <button type="submit" name="btn_updatePost" class="btn btn-primary">Thêm mới</button>
                            </form>
                        </div>
                    </div>
                </div>
